...
SERIES: dict[str, list[dict[str, Any]]] = {
    ...
    "NFL": [
        # The core moneyline series is the NFL readiness anchor.
...
def market_metadata(
    ...
    return {
        ...
        "rulesPrimary": str(market.get("rules_primary") or "")[:12000],
        "rulesSecondary": str(market.get("rules_secondary") or "")[:12000],
        "settlementValueDollars": as_float(market.get("settlement_value_dollars")),
        "settlementTimestamp": str(market.get("settlement_ts") or market.get("settlement_time") or market.get("settled_time") or ""),
